...
- Proactively launch seasonal promotions: especially mid-year (June–August), such as product combos, summer discounts, or online channel promotions.

**Second: Switch to a flexible positioning strategy**
- Diversify the product portfolio and add seasonal products to meet consumer needs.
- In addition to focusing on the premium segment, create some lower-priced products to compete in the mass market and avoid losing customers to competitors.

**Third: Improve operations and internal human resources**
- Train sales staff to standardize the customer experience.
- Organize regular quality checks at all points of sale or production sites.
- Implement a customer feedback loop (continuous collection and processing of feedback).
- Improve after-sales service: easy warranty and returns, 24/7 customer care.
